...
object NavRoutes {
    ...
    const val LEADER_PRODUCT_FORM = "leader_product_form?productId={productId}"
    const val LEADER_PRODUCT_FORM_PREFIX = "leader_product_form"
    const val LEADER_ORDERS = "leader_orders"
    const val LEADER_INVENTORY = "leader_inventory"
    const val LEADER_INSIGHTS = "leader_insights"
