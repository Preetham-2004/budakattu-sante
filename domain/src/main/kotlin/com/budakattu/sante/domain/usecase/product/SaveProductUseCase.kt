...
class SaveProductUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val product = Product(
            productId = existingProduct?.productId ?: buildProductId(draft.name, now),
            familyId = existingProduct?.familyId ?: buildFamilyId(draft.familyName),
            ...
            preorderLimit = draft.preorderLimit,
            ...
            addedAt = existingProduct?.addedAt ?: now,
            lastModifiedAt = now,
        )
